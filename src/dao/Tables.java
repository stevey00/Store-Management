...
//            st.executeUpdate("insert into appuser (userRole, name, dob, mobileNumber, email, username, password, address) values('Admin', 'Admin', '19-12-1990', '0000111122', 'admin@gmail.com', 'admin', 'admin', 'Cameroon' ) ");
